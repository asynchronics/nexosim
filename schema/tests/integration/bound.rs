...
// The default trait bounds would require T/U to implement Message, which MyIterator does not.
#[derive(Message, Serialize, Deserialize, Default)]
#[schemars(bound = "T::Item: Message")]
...
// `T` doesn't need to impl `Message`, but `U` does
#[derive(Message, Serialize, Deserialize, Default)]
