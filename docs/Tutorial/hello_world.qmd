...
In this section we will create a very simple simulation with a single model that
...
client. This will serve as an introduction to the general structure and usage of
NeXosim.
...
We also need to add NeXosim to the project's dependencies.
