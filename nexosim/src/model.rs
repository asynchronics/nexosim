...
//! the model struct. Definition of an `init` method can be provided by
//! using a custom attribute `#[nexosim(init)]`.
...
//! [`schedulable!`] macro when passed to the scheduler.
//!
//! ```
